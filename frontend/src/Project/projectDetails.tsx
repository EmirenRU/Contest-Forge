    ...
    import type { EstimatedCost, ProjectData, ResearchTeamMember } from "./project";
...
const handleAddTeamMember = useCallback((event: React.MouseEvent<HTMLButtonElement>): void => {
        ...
        const handleAddCostItem =  useCallback((event: React.MouseEvent<HTMLButtonElement>): void => {
            event.preventDefault();
        ...
        return (
            <div className="d-flex flex-column" style={{ width: '100%',   }}>
                ...
                <div className="form-group">
                    <label className="form-label me-2">Состав научного коллектива</label>
    ...
    <div key={`member-${index}`} className="card mb-3 p-3">
                    ...
                    <button
                        type="button"
                        onClick={(e)=>handleAddTeamMember(e)}
